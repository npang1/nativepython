...
from object_database.web.AuthContextPlugin import AuthContextPlugin, User
...
class ActiveWebServiceTest(unittest.TestCase):
    ...
    def configurableSetUp(self, hostname='localhost',
                          auth_plugin_context=AuthContextPlugin,
        ...
        try:
            ...
            ActiveWebService.setAuthPlugin(
                self.database,
                service,
                auth_plugin_context,
                auth_plugins,
    ...
    def waitUntilUp(self, timeout = 4.0):
        ...
        raise Exception("Webservice never came up (timeout={}).".format(timeout))
